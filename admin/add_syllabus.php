...
mysqli_query($con,"insert into syllabus (c_name,sem,sub_name,s_file) values ('$cnm','$scm','$smm','$fn')")or die("qf");
header ("location:show_syllabus.php?s1=1");
}
include("connect.php");
?>
<!DOCTYPE HTML>
      ...
      <nav class="navbar navbar-inverse">
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<!--toggle button start-->
				<button id="showLeftPush"><i class="fa fa-bars" class=".page-wrapper"></i></button>
				<!--toggle button end-->
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1">Add New Syllabus </h2>
