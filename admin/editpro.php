...
include 'top.php';
mysqli_query($con,"update admin set name = '$cnm', mobile = '$scm', emailid = '$smm',a_photo='$fn'where aid='$i'")or die("qf");
				  ...
				  <form action="" method="post" enctype="multipart/form-data" name="form1">
				    <table width="70%" height="250" align="center" style="border-style:groove; border-color:#169DA5">
                      ...
                      <tr>
                        <td>&nbsp;&nbsp;Upload Photo </td>
                        <td>:</td>
                        <td><input class="form-control-file" name="s_file" type="file" id="s_file" required autofocus></td>
                      </tr>
                      <tr>
