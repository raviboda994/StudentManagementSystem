...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1">Faculties Data </h2>
				 ...
				 <table width="100%"  height="250" style="border-style:groove; border-color:#169DA5" align="center">
                   <tr class="btn-info">
                     ...
                     <td><strong>Master Sub. </strong></td>
				 ...
				 ?>
				   <tr>
                     ...
                     <td><img src="faculties_photos/<?php echo $data['f_photo'];?>?url=faculties_photos/<?php echo $data['f_photo'];?>" height="100" width="100" class="dg-picture-zoom"></td>
                     <td><a href="delete_faculty.php?did=<?php echo $data['fid'];?>" onClick="return f1();"><img src="images/delete1.png"></a></td>
                   </tr>
				  <?php
				  $no++;
				  }
