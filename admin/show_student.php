...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1">Student Data </h2>
				 
				 <table width="100%"  height="250" style="border-style:groove; border-color:#169DA5" align="center">
                   <tr class="btn-info">
				 ...
				 $no=1;
				 include("connect.php");
				 $q=mysqli_query($con,"select * from student")or die ("QF");
				 ...
				 ?>
				   <tr>
                     ...
                     <td><img src="Student_photos/<?php echo $data['S_photo'];?>?url=Student_photos/<?php echo $data['S_photo'];?>" height="100" width="100" class="dg-picture-zoom"></td>
                     <td><a href="delete_student.php?did=<?php echo $data['SID'];?>" onClick="return f1();"><img src="images/delete1.png"></a></td>
                   </tr>
				  <?php
				  $no++;
				  }
...
<?php if(isset($_REQUEST['f1'])=="1") { ?>
<script language="javascript">
alert("Student Added");
</script>
<?php } ?>

<?php if(isset($_REQUEST['f2'])=="2") { ?>
<script language="javascript">
